...
<tbody>
    <tr>
        ...
        <td width="200">Frontend<br>메인화면 및 일정생성(동행자 추가, 여행 기간 선택 등) 화면</td>
    ...
    <tr>
        ...
        <td width="200">Backend(Firebase 관련 서비스)<br>스플래쉬, 로그인 화면</td>
        <td width="100" align="center">
    ...
    <tr>
        ...
        <td width="200">Frondend<br>마이페이지 및 설정화면</td>
        <td width="100" align="center">
