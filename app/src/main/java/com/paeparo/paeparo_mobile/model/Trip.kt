...
data class Trip(
    ...
    @set:PropertyName("latitude") @get:PropertyName("latitude") @SerializedName("latitude") var latitude: Double = 0.0,
    @set:PropertyName("longitude") @get:PropertyName("longitude") @SerializedName("longitude") var longitude: Double = 0.0,
    @set:PropertyName("transportation") @get:PropertyName("transportation") @SerializedName("transportation") var transportation: String = "",
